...
NDefines.NDiplomacy.PO_BECOME_VASSAL_AE =  	0.45
NDefines.NDiplomacy.PO_RETURN_CORES_AE = 0.675
NDefines.NDiplomacy.PO_DEMAND_PROVINCES_AE = 0.675
...
NDefines.NEconomy.LAND_TECH_MAINTENANCE_IMPACT = 0.03			-- BT changed from 0.02
NDefines.NEconomy.NAVAL_TECH_MAINTENANCE_IMPACT = 0.03			-- BT changed from 0.02
